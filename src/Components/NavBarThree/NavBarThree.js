...
const NavBarThree = () => {
  ...
  const handleMobileButtonClick = (e) => {
    e.stopPropagation();
    const menuItemsList = document.querySelector(`.${INITIAL_CLASSNAME}-menu-items`);
  ...
  const handleSearchIconClick = ()=>{
    const searchBoxContainer = document.querySelector(`.${INITIAL_CLASSNAME}-search-text-box-container`);
    const searchTextBox = document.querySelector(`.${INITIAL_CLASSNAME}-search-text-box`);
    ...
    <div className={`${INITIAL_CLASSNAME}-page`} onClick={closeSideMenu}>
      <div className={`${INITIAL_CLASSNAME}-nav-and-content-container`}>
        ...
        <div className={`${INITIAL_CLASSNAME}-nav-container`}>
          ...
          <div className={`${INITIAL_CLASSNAME}-mode-switch`} onClick={handleModeButtonClick}></div>

          {/* Mobile Menu Button - OPEN */}
          <i className={`fa fa-bars ${INITIAL_CLASSNAME}-mobile-menu-button-open`} onClick={handleMobileButtonClick}></i>
          ...
          <ul className={`${INITIAL_CLASSNAME}-menu-items`}>
            <li>
              {/* Mobile Menu Button - OPEN */}
              <i className={`fa fa-close ${INITIAL_CLASSNAME}-mobile-menu-button-close`} onClick={handleMobileButtonClick}></i>
            </li>
          ...
          <div className={`${INITIAL_CLASSNAME}-search-box`}>
            ...
            <div className={`${INITIAL_CLASSNAME}-search-text-box-container`}>
              <input type="search" className={`${INITIAL_CLASSNAME}-search-text-box`}/>
            </div>
          </div>
        </div>
